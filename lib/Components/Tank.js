    ...
    CheckAlarmLevels() {
        ...
        if (this.LowLevelAlarmCode !== 0) {
            ...
            if (this.Content < this.LowLevelAlarm) {
                (_a = this.AlarmSystem) === null || _a === void 0 ? void 0 : _a.AddAlarm(this.LowLevelAlarmCode);
            }
            // cancel alarm is previous raised and now above LowLevelAlarm
            if (((_b = this.AlarmSystem) === null || _b === void 0 ? void 0 : _b.AlarmExist(this.LowLevelAlarmCode)) && this.Content >= this.LowLevelAlarm) {
        ...
        if (this.EmptyAlarmCode !== 0) {
            ...
            if (this.Content === 0) {
                (_c = this.AlarmSystem) === null || _c === void 0 ? void 0 : _c.AddAlarm(this.EmptyAlarmCode);
            }
            // cancel alarm is previous raised and tank is no longer empty
            if (((_d = this.AlarmSystem) === null || _d === void 0 ? void 0 : _d.AlarmExist(this.EmptyAlarmCode)) && this.Content !== 0) {
