...
const dummySource = new mockTank_1.default('dummy source tank', 1000, 887);
const dummySourceValve = new mockValve_1.default('test dummy source valve', dummySource);
beforeEach(() => {
...
describe('Drain valve', () => {
    test('open drain valve = remove from tank', () => {
        ...
        const drainTarget = new mockTank_1.default('test drain tank', 1000);
        tankV.Tank.Inside = startContent;
