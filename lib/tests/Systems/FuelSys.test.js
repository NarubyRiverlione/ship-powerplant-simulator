...
const FuelSys_1 = __importDefault(require("../../Systems/FuelSys"));
...
beforeEach(() => {
    fuelSys = new FuelSys_1.default(dummyAlarmSys);
});
...
describe('Alarms', () => {
    test('Raise Low diesel storage tanks', () => {
        ...
        fuelSys.DsStorage.Tank.Inside = CstAlarms_1.AlarmLevel.FuelSys.LowDsStorage;
        fuelSys.Thick();
        expect(dummyAlarmSys.AlarmExist(CstAlarms_1.AlarmCode.LowDsStorageTank)).toBeFalsy();
        // raise alarm
        fuelSys.DsStorage.Tank.Inside = CstAlarms_1.AlarmLevel.FuelSys.LowDsStorage - 0.1;
        fuelSys.Thick();
        expect(dummyAlarmSys.AlarmExist(CstAlarms_1.AlarmCode.LowDsStorageTank)).toBeTruthy();
    });
    test('Cancel Low diesel storage tanks', () => {
        // full service tank to prevent low service alarm
        fuelSys.DsService.Tank.Inside = CstFuelSys.DsStorageTank.TankVolume;
        // at alarm level = no alarm yet, must be below
        fuelSys.DsStorage.Tank.Inside = CstAlarms_1.AlarmLevel.FuelSys.LowDsStorage - 5;
        fuelSys.Thick();
        expect(dummyAlarmSys.AlarmExist(CstAlarms_1.AlarmCode.LowDsStorageTank)).toBeTruthy();
    ...
    test('Raise Low diesel service tanks', () => {
        ...
        fuelSys.DsStorage.Tank.Inside = CstFuelSys.DsStorageTank.TankVolume;
        // at alarm level = no alarm yet, must be below
        fuelSys.DsService.Tank.Inside = CstAlarms_1.AlarmLevel.FuelSys.LowDsService;
        fuelSys.Thick();
        expect(dummyAlarmSys.AlarmExist(CstAlarms_1.AlarmCode.LowDsServiceTank)).toBeFalsy();
        // raise alarm
        fuelSys.DsService.Tank.Inside = CstAlarms_1.AlarmLevel.FuelSys.LowDsService - 0.1;
        fuelSys.Thick();
        expect(dummyAlarmSys.AlarmExist(CstAlarms_1.AlarmCode.LowDsServiceTank)).toBeTruthy();
    });
    test('Cancel Low diesel service tanks', () => {
        // full service tank to prevent low service alarm
        fuelSys.DsStorage.Tank.Inside = CstFuelSys.DsStorageTank.TankVolume;
        // raise alarm
        fuelSys.DsService.Tank.Inside = CstAlarms_1.AlarmLevel.FuelSys.LowDsService - 5;
        fuelSys.Thick();
        expect(dummyAlarmSys.AlarmExist(CstAlarms_1.AlarmCode.LowDsServiceTank)).toBeTruthy();
        // above low level = cancel alarm
        fuelSys.DsService.Tank.Inside = CstAlarms_1.AlarmLevel.FuelSys.LowDsService;
    ...
    test('Raise Empty diesel storage tanks', () => {
        ...
        fuelSys.Thick();
        expect(dummyAlarmSys.AlarmExist(CstAlarms_1.AlarmCode.EmptyDsStorageTank)).toBeFalsy();
        fuelSys.DsStorage.Tank.Inside = 0;
        fuelSys.Thick();
        expect(dummyAlarmSys.AlarmExist(CstAlarms_1.AlarmCode.EmptyDsStorageTank)).toBeTruthy();
    });
    ...
    test('Raise Empty diesel service tanks', () => {
        ...
        fuelSys.Thick();
        expect(dummyAlarmSys.AlarmExist(CstAlarms_1.AlarmCode.EmptyDsServiceTank)).toBeFalsy();
        fuelSys.DsService.Tank.Inside = 0;
        fuelSys.Thick();
        expect(dummyAlarmSys.AlarmExist(CstAlarms_1.AlarmCode.EmptyDsServiceTank)).toBeTruthy();
    });
