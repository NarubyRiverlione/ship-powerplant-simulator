...
const CoolingSys_1 = __importDefault(require("../../Systems/CoolingSys"));
const dummyEmergencyBus = new PowerBus_1.default('dummy emergency bus');
dummyEmergencyBus.Voltage = 440;
const dummyMainBus = new PowerBus_1.default('dummy main bus');
dummyMainBus.Voltage = 440;
let coolingSys;
beforeEach(() => {
    coolingSys = new CoolingSys_1.default(dummyMainBus, dummyEmergencyBus);
});
describe('Init', () => {
    ...
    test('FW cooler diesel generator 2, not cooling', () => {
        ...
        expect(FwCoolerDsGen2.CoolingInputRate).toBe(Cst_1.CstCoolantSys.FwCoolerDsGen2.coolingRate);
    ...
    test('Steam conderser, not cooling', () => {
        ...
        expect(SteamCondensor.CoolingInputRate).toBe(Cst_1.CstCoolantSys.SteamCondensor.coolingRate);
    ...
    test('FW cooler diesel generator 1, not cooling', () => {
        ...
        expect(FwCoolerDsGen1.CoolingInputRate).toBe(Cst_1.CstCoolantSys.FwCoolerDsGen2.coolingRate);
...
describe('Sea chests', () => {
    test('Low suction intake valve open = content', () => {
        ...
        expect(SeaChestLowSuctionIntakeValve.Content).toBe(Cst_1.CstCoolantSys.SeaChest);
    });
    test('High suction intake valve open = content', () => {
        ...
        expect(SeaChestHighSuctionIntakeValve.Content).toBe(Cst_1.CstCoolantSys.SeaChest);
    });
...
describe('Suction pumps', () => {
    test('Aux pump with low suction valve open = output is rated', () => {
        ...
        expect(coolingSys.SwAvailable.Inside).toBe(Cst_1.CstCoolantSys.AuxSuctionPump);
    });
    test('Suction pump 1 with low suction valve open = output is rated', () => {
        ...
        expect(SuctionPump1.Providers).toBe(Cst_1.CstCoolantSys.SeaChest);
        expect(SuctionPump1.Content).toBe(Cst_1.CstCoolantSys.SuctionPumps);
        expect(coolingSys.SwAvailable.Inside).toBe(Cst_1.CstCoolantSys.SuctionPumps);
    });
    test('Suction pump 2 with high suction valve open = output is rated', () => {
        ...
        expect(SuctionPump2.Providers).toBe(Cst_1.CstCoolantSys.SeaChest);
        expect(SuctionPump2.Content).toBe(Cst_1.CstCoolantSys.SuctionPumps);
        expect(coolingSys.SwAvailable.Inside).toBe(Cst_1.CstCoolantSys.SuctionPumps);
    });
    ...
    test('Suction pump 1 & aux pump running  = output is aux + suction', () => {
        ...
        AuxPump.Start();
        coolingSys.Thick();
        expect(coolingSys.SwAvailable.Inside).toBe(Cst_1.CstCoolantSys.SuctionPumps + Cst_1.CstCoolantSys.AuxSuctionPump);
    });
});
describe('Over board valve', () => {
    ...
    test('over board vale open and aux pump running = valve has  content', () => {
        ...
        expect(AuxPump.isRunning).toBeTruthy();
        expect(AuxPump.Content).toBe(Cst_1.CstCoolantSys.AuxSuctionPump);
        expect(OverboardDumpValve.Content).toBe(Cst_1.CstCoolantSys.AuxSuctionPump);
    });
    test('Aux pump running, low sea suction valve open but over board valve is closed = no cooling', () => {
        const { AuxPump, FwCoolerDsGen1, FwCoolerDsGen2, OverboardDumpValve, SteamCondensor } = coolingSys;
        coolingSys.SeaChestLowSuctionIntakeValve.Open();
        AuxPump.Start();
    ...
    test('Had cooling via high sea chest & SuctionPump1 but now closing overboard valve = stop cooling', () => {
        const { SuctionPump1, FwCoolerDsGen1, FwCoolerDsGen2, OverboardDumpValve, SteamCondensor } = coolingSys;
        coolingSys.SeaChestLowSuctionIntakeValve.Open();
        SuctionPump1.Start();
        OverboardDumpValve.Open();
        coolingSys.Thick();
...
describe('Aux pump', () => {
    test('Aux pump providing cooling for FW dsgen, not to steam condensor', () => {
        ...
        expect(FwCoolerDsGen1.CoolingProviders).toBe(Cst_1.CstCoolantSys.AuxSuctionPump);
...
describe('Suction pumps ', () => {
    ...
    test('Suction pump 2 providing cooling for FW dsgen AND to steam condensor', () => {
        const { SuctionPump2, FwCoolerDsGen1, FwCoolerDsGen2, OverboardDumpValve, SteamCondensor } = coolingSys;
        coolingSys.SeaChestLowSuctionIntakeValve.Open();
        SuctionPump2.Start();
        OverboardDumpValve.Open();
        coolingSys.Thick();
...
describe('Fresh water expand tank', () => {
    test('fill expand tank by open the intake valve', () => {
        ...
        coolingSys.Thick();
        expect(coolingSys.FwExpandTank.Content).toBe(Cst_1.CstCoolantSys.FwExpandTank.TankAddStep);
        expect(coolingSys.FwIntakeValve.Content).toBe(Cst_1.CstCoolantSys.FwMakeUp);
    });
    ...
    test('Drain expand tank', () => {
        ...
        coolingSys.Thick();
        expect(coolingSys.FwExpandTank.Content).toBe(startContent - Cst_1.CstChanges.DrainStep);
...
describe('Diesel gen 1 lubrication cooler', () => {
    ...
    test('has cooling +  Fw cooler is cooling', () => {
        const { AuxPump, FwCoolerDsGen1, OverboardDumpValve, DsGen1LubCooler } = coolingSys;
        // setup Fw cooler
        coolingSys.SeaChestLowSuctionIntakeValve.Open();
        AuxPump.Start();
        OverboardDumpValve.Open();
...
describe('Diesel gen 2 lubrication cooler', () => {
    ...
    test('has cooling +  Fw cooler is cooling', () => {
        const { AuxPump, FwCoolerDsGen2, OverboardDumpValve, DsGen2LubCooler } = coolingSys;
        // setup Fw cooler
        coolingSys.SeaChestLowSuctionIntakeValve.Open();
        AuxPump.Start();
        OverboardDumpValve.Open();
