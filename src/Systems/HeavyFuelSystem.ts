...
export default class HeavyFuelSystem {
  ...
  constructor(mainSteamValve: ValveInterface, mainBus: PowerBus) {
    ...
    // #region Service
    this.HfPurification = new PurificationUnit(FuelSysTxt.HfPurification,
      CstHfFuelSys.HfPurification.Volume, this.HfSettelingTank.OutletValve, mainBus)
  ...
  get HasBunkOutput() {
    return this.HfForeBunker.OutletValve.Content !== 0
      || this.HfAftBunker.OutletValve.Content !== 0
      || this.HfPortBunker.OutletValve.Content !== 0
      || this.HfStarboardBunker.OutletValve.Content !== 0
  }
  ...
  Thick() {
    ...
    this.HfPump.Providers = this.HfForeBunker.OutletValve.Content
      + this.HfAftBunker.OutletValve.Content
      + this.HfPortBunker.OutletValve.Content
      + this.HfStarboardBunker.OutletValve.Content
